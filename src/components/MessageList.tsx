...
export function MessageList({ messages, hostName, className }: { messages: ChatMessage[]; hostName?: string; className?: string }) {
  ...
  return (
    <div ref={listRef} className={cn("flex-1 space-y-2.5 overflow-y-auto px-4 py-3", className)} aria-live="polite" aria-relevant="additions">
      {messages.length === 0 ? (
