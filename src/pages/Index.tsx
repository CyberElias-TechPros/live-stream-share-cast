          ...
          <section className="py-16 md:py-24 container">
            <div className="max-w-3xl mx-auto text-center">
              <h1 className="text-4xl md:text-5xl font-bold mb-6 text-white">
                 <span className="text-stream-light">See Your Stream Instantly</span>
              </h1>
              <p className="text-lg md:text-xl text-muted-foreground mb-8">
                Stream live video, share it with anyone, and record your broadcasts
                all in one secure platform. No downloads required.
              </p>
            ...
            <div className="container">
              ...
              <div className="grid md:grid-cols-3 gap-8">
                ...
                <div className="bg-card p-6 rounded-lg border border-border">
                  ...
                  <p className="text-muted-foreground">
                    End-to-end encryption and privacy controls ensure your streams 
                    are secure and only seen by intended viewers.
                  </p>
                </div>
                ...
                <div className="bg-card p-6 rounded-lg border border-border">
                  ...
                  <p className="text-muted-foreground">
                    Experience real-time streaming with industry-leading low latency 
                    for interactive broadcasts.
                  </p>
                </div>
                ...
                <div className="bg-card p-6 rounded-lg border border-border">
                  ...
                  <p className="text-muted-foreground">
                    Works seamlessly across all devices and browsers without 
          ...
          <div className="container">
            <div className="flex flex-col md:flex-row justify-between items-center">
              ...
              <div className="flex gap-6 mt-4 md:mt-0">
                ...
                <Link to="/help" className="text-muted-foreground hover:text-foreground transition">
                  Help
                </Link>
              </div>
            </div>
